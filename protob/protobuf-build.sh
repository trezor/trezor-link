...
# npx pbjs -t json ./messages.proto > ./foo-messages.json
npx pbjs -t json --keep-case tests/protob/messages.proto tests/protob/messages-binance.proto > foo-bundle.json
